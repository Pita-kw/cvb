...
function CEGUI:onClickedButton(button)
	if button=='start' then
		triggerServerEvent('startTreeJobServer', resourceRoot, localPlayer)
...
GUIClass=CEGUI:new('Pracuj', 'Anuluj', 'Koszenie trawy', 'Praca polega na skoszeniu nadmiaru trawy. Wynagrodzenie jest zależne od ilości skoszonej trawy. Po skończeniu pracy opuść pojazd i podejdź do bota po wynagrodzenie.\n\nWynagrodzenie za każdą trawę: $50.\nEXP za 10 skoszonej trawy: 1.')
