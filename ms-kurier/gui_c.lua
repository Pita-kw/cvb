...
function CEGUI:onClickedButton(button)
	if button=='start' then
		triggerServerEvent('startJobKurier', resourceRoot, localPlayer)
...
GUIClass=CEGUI:new('Pracuj', 'Anuluj', 'Kurier', 'Dowież przesyłkę do wyznaczonego punktu na mapie. Gdy dojedziesz na miejsce wysiądz z pojazdu i wyciągnij paczkę z pojazdu a następnie zanieś we wskazane miejsce. Gdy wszystko przebiegnie pomyślnie wróć do bazy i odbierz swoje wynagrodzenie. Powodzenia!')
