...
function CEGUI:onClickedButton(button)
	if button=='start' then
		triggerServerEvent('startJobKlift', resourceRoot, localPlayer)
...
GUIClass=CEGUI:new('Pracuj', 'Anuluj', 'Widlak', 'Przewieź wszystkie skrzynki do magazynu obok. Uważaj ponieważ skrzynki lubią się ślizgać. Jedź ostrożnie aby nie uszkodzić żadnego towaru. Po zakończeniu zadania wróć do bota aby odebrać swoje wynagrodzenie. Miłej pracy!')
