...
function CEGUI:onClickedButton(button)
	if button=='start' then
		triggerServerEvent("onPlayerStartElectrician", localPlayer)
...
GUIClass=CEGUI:new('Pracuj', 'Anuluj', 'Elektryk', 'Dojedź w wznaczone miejsce i napraw usterkę. Przy naprawie bądź ostrożny poniważ w przypadku błędu, możesz zostać porażony prądem. Pamiętaj że masz ograniczony czas na naprawę. Podczas naprawy uważaj gdyż możesz spalić układ.')
