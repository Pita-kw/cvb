...
function enableDetail()
	...
	if not bAllValid then
		...
		engineApplyShaderToWorldTexture ( roadShader, "*BLOCK*" )
		...
		engineApplyShaderToWorldTexture ( concreteShader, "*ceiling*" )
		...
		engineApplyShaderToWorldTexture ( road2Shader, "*grey*" )
		...
		engineApplyShaderToWorldTexture ( roadShader, "*sheet*" )
		...
		engineApplyShaderToWorldTexture ( road2Shader, "*grnd*" )
		engineApplyShaderToWorldTexture ( road2Shader, "*etal*" )
		engineApplyShaderToWorldTexture ( roadShader, "*steel*" )
		engineApplyShaderToWorldTexture ( roadShader, "*pylon*" )
		engineApplyShaderToWorldTexture ( concreteShader, "*crush*" )
		engineApplyShaderToWorldTexture ( roadShader, "*tower*" )
		engineApplyShaderToWorldTexture ( paveDirtyShader, "*pipe*" )
		engineApplyShaderToWorldTexture ( paveDirtyShader, "*paint*" )
		engineApplyShaderToWorldTexture ( road2Shader, "*rust*" )
		engineApplyShaderToWorldTexture ( paveDirtyShader, "*frame*" )
		engineApplyShaderToWorldTexture ( road2Shader, "*bedings*" )
		engineApplyShaderToWorldTexture ( concreteShader, "*chat*" )
		engineApplyShaderToWorldTexture ( grassShader, "faketurf_law" )
		engineApplyShaderToWorldTexture ( road2Shader, "bevr03b_law" )
		engineApplyShaderToWorldTexture ( concreteShader, "*LAMPPOST*" )
		engineApplyShaderToWorldTexture ( road2Shader, "CJ_OIL_DRUM" )
		engineApplyShaderToWorldTexture ( road2Shader, "CJ_o2Tank" )
		engineApplyShaderToWorldTexture ( concreteShader, "sam_camo" )
		engineApplyShaderToWorldTexture ( concreteShader, "bonyrd_skin2" )
		engineApplyShaderToWorldTexture ( concreteShader, "cabin5" )
		engineApplyShaderToWorldTexture ( road2Shader, "*vent*" )
		engineApplyShaderToWorldTexture ( grassShader, "kb_ivy2_256" )
		engineApplyShaderToWorldTexture ( grassShader, "*planter*" )
		engineApplyShaderToWorldTexture ( grassShader, "kb_balcony_ferns" )
		engineApplyShaderToWorldTexture ( roadShader, "*flr*" ) 
		engineApplyShaderToWorldTexture ( roadShader, "*golf_*" ) 
		engineApplyShaderToWorldTexture ( roadShader, "*berrybush*" )
		engineApplyShaderToWorldTexture ( roadShader, "cedar1" )
		engineApplyShaderToWorldTexture ( roadShader, "cedar2" )
		engineApplyShaderToWorldTexture ( roadShader, "cypress1" )
		engineApplyShaderToWorldTexture ( roadShader, "cypress2" )
		engineApplyShaderToWorldTexture ( roadShader, "*oakbark*" )
		engineApplyShaderToWorldTexture ( roadShader, "pinewood" )
		engineApplyShaderToWorldTexture ( roadShader, "oakleaf1" )
		engineApplyShaderToWorldTexture ( roadShader, "oakleaf2" )
		engineApplyShaderToWorldTexture ( roadShader, "pinebranch2" )
		engineApplyShaderToWorldTexture ( roadShader, "bchamae" )
		engineApplyShaderToWorldTexture ( roadShader, "bthuja1" )
		engineApplyShaderToWorldTexture ( roadShader, "*spruce*" )
		engineApplyShaderToWorldTexture ( roadShader, "*ctmall*" )
		engineApplyShaderToWorldTexture ( grassShader, "aamanbev96x" )
		engineApplyShaderToWorldTexture ( grassShader, "hay" )
		engineApplyShaderToWorldTexture ( roadShader, "*_barn*" )
		
		-- Remove detail from LOD models and unwanted objects/vehicles
		for i,part in ipairs(effectParts) do
			if getElementType(part) == "shader" then
				...
				engineApplyShaderToWorldTexture ( part, "grass" )
			end
		end
	end
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ("fx/detail.fx", 0, 100)
	if shader then
