...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow(20, (screenH - info.selectWindow.height)-20,
		                                        info.selectWindow.width, info.selectWindow.height-10, "Wybierz kolor", false)
		...
		checkColor1 = guiCreateCheckBox(info.selectWindow.ra1X, info.selectWindow.ra1Y,
												70, 15, "Kolor 1", false, false, colorPicker.GUI.selectWindow)

		checkColor2 = guiCreateCheckBox(info.selectWindow.ra2X, info.selectWindow.ra2Y,
												70, 15, "Kolor 2", false, false, colorPicker.GUI.selectWindow)

		checkColor3 = guiCreateCheckBox(info.selectWindow.ra3X, info.selectWindow.ra3Y,
												70, 15, "Kolor 3", true, false, colorPicker.GUI.selectWindow)

		checkColor4 = guiCreateCheckBox(info.selectWindow.ra4X, info.selectWindow.ra4Y,
												70, 15, "Kolor 4", true, false, colorPicker.GUI.selectWindow)

		checkColor5 = guiCreateCheckBox(info.selectWindow.ra5X, info.selectWindow.ra5Y,
												75, 15, "Światła", false, false, colorPicker.GUI.selectWindow)
		guiSetVisible(checkColor4, false)
		guiSetVisible(checkColor3, false)
