...
SHOW_DOWNLOAD_INFO = false -- true/false - show download information on screen
...
DISABLE_ENGINE_START_SOUND = false -- true/false - works globally on all vehicles! 
